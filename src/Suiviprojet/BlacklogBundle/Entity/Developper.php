...
class Developper
{
     ...
     * @return Developper
     */
    public function addEquipeequipe(\Suiviprojet\BlacklogBundle\Entity\Equipe $equipeequipe)
    {
     ...
     * @param \Suiviprojet\BlacklogBundle\Entity\Equipe $equipeequipe
     */
    public function removeEquipeequipe(\Suiviprojet\BlacklogBundle\Entity\Equipe $equipeequipe)
    {
