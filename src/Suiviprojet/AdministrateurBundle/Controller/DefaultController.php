...
class DefaultController extends Controller {
    ...
    public function createCompteClientAction() {
        ...
        return $this->render('SuiviprojetAdministrateurBundle:Admin:createClient.html.twig', array('form' => $form->createView(),
                ));
    }
    ...
    public function createProjetAction() {
        ...
        return $this->render('SuiviprojetAdministrateurBundle:Admin:createProjet.html.twig', array('form' => $form->createView(),
                ));
